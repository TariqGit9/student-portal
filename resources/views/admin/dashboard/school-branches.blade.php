...
<div class="breadcrumb-header justify-content-between">
  <div class="my-auto">
    <div class="d-flex">
      <h4 class="content-title mb-0 my-auto">Branches</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0"></span>
    </div>
  </div>
</div>
<div class="col-xl-12">
  <div class="card">
    <div class="card-header pb-0">
      <div class="d-flex justify-content-between">
        ...
        <i class="mdi "><span class="float-right" ><button type="button" class="btn btn-secondary" data-toggle="modal" data-target=".addSchoolModel">Add a branch</button></span></i>
      </div>
    </div>
    <div class="card-body">
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            <div class="input-group file-browser">
                <input type="text" class="custom-file-label form-control browse-file" placeholder="Choose Branch Avatar" readonly>
          ...
          <div class="form-row">
            <div class="form-group col">
              <label class="bmd-label-floating">School Details</label>
...
function format(d) {
    ...
    return new Promise((resolve, reject) => {
       axios.post("{{route('get-branch-detail-admin')}}", {
            id: d.id
...
$(document).on('click', '.addschool', function() {
  ...
  //please_wait
   ...
   // var formData = new FormData();
    ...
    axios.post("{{route('add-branch-admin')}}",
        formData
    ).then(function(response) {
...
$(document).on('click', '.editSchoolInfo', function() {
  ...
  if($("#edit_name").val() == ""){
   ...
   // var formData = new FormData();
    ...
    axios.post("{{route('edit-branch-admin')}}",
        formData
    ).then(function(response) {
