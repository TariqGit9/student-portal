  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTitle"><i class="fe fe-send mr-2"></i>Send Notification to Students</h5>
...
$('#openCreateModal').on('click', function() {
  ...
  $('#notif_expiry').val('');
  $('#modalTitle').html('<i class="fe fe-send mr-2"></i>Send Notification to Students');
...
$('#saveNotification').on('click', function() {
  ...
  var payload = { title: title, message: message, target_audience: 'student', expiry_date: expiry };
  if (id) payload.id = id;
